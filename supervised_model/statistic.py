...
def event_extraction(sample_path, dv_model, np_path, log):
    ...
    event_count = obtain_activity_vector(phase_dict, filename, dv_model, np_path, log, simDict)
    return event_count
...
if __name__ == "__main__":
    ...
    for dir in os.listdir(miss_sample_dir):
        ...
        for sample in os.listdir(sample_dir):
            ...
            event_count += event_extraction(sample_path, dv_model, np_path, log)
    
    print('event_count is : ')
    print(event_count)
    print('sample_num is : ')
    print(sample_num)
