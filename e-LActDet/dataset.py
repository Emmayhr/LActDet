...
if __name__== "__main__" :
    ...
    miss_dataset = MyDataset(miss_event_dir)
    restore(miss_dataset, "dataset/miss_event_train.t", "dataset/miss_event_test.t")
    false_dataset = MyDataset(false_event_dir)
    restore(false_dataset, "dataset/false_event_train.t", "dataset/false_event_test.t")
